 ...
 * @property {String}  返回图标右边的辅助提示文字
 * @property {Object} -style 返回图标右边的辅助提示文字的样式，对象形式（默认{ color: '#606266' }）
 ...
 * @example <u-navbar ="返回" title="剑未配妥，出门已是江湖"></u-navbar>
 */
export default {
  name: "u-navbar",
  props: {
